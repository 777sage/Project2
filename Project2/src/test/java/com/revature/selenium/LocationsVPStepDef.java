...
public class LocationsVPStepDef {
	 ...
	 WebDriverWait wait = new WebDriverWait(ServiceHooks.driver, 15);
	...
	public void add_location_button_pressed() throws Throwable {
		...
		//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\\'locAdd\\']")));
		...
		try {
	    	...
	    	Service.updateTest("Add location button exists", "Failed");
		}
	...
	public void check_if_pop_up_opened() throws Throwable {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//form[@name='locationForm']")));
	...
	public void location_name_city_and_state() throws Throwable {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@id,'dialogContent_6')]/div/div/md-input-container/input")));
	...
	public void check_if_the_location_was_added() throws Throwable {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[contains(@aria-label, 'Moon')]")));

		WebElement element = ServiceHooks.driver.findElement(By.xpath("//button[contains(@aria-label, 'Moon')]"));
		element.click();
		ServiceHooks.driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		...
		try {
	    	...
	    	Service.updateTest("Location was added", "Failed");
		}
	}
	...
	public void newly_added_location_is_selected_press_the_add_building_button() throws Throwable {
		...
		System.out.println("In adding a building to location, before trying to find the checkbox xpath");
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(text(),'Moon')]/../../md-checkbox")));

		ServiceHooks.driver.findElement(By.xpath("//*[contains(text(),'Moon')]/../../md-checkbox/div")).click();
		ServiceHooks.driver.findElement(By.xpath("//*[@id=\"bldgAdd\"]")).click();
	}
	...
	public void see_if_the_new_building_pop_up_appears() throws Throwable {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//md-dialog[contains(@aria-label,'Edit Building')]/form/div/md-dialog-content/div/*/md-input-container/input")));

		WebElement element = ServiceHooks.driver.findElement(By.xpath("//md-dialog[contains(@aria-label,'Edit Building')]/form/div/md-dialog-content/div/*/md-input-container/input"));
		try {
			assertNotNull(element);
			Service.updateTest("Building pop up appears", "Success");
		} catch (Error e) {
			Service.updateTest("Building pop up appears", "Failed");
		}
	}
	...
	public void a_building_name() throws Throwable {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[3]/md-dialog/form")));

		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//md-dialog[contains(@aria-label,'Edit Building')]/form/div/md-dialog-content/div/*/md-input-container/input")));

		WebElement element = ServiceHooks.driver.findElement(By.xpath("//md-dialog[contains(@aria-label,'Edit Building')]/form/div/md-dialog-content/div/*/md-input-container/input"));
		element.sendKeys("ThroneRoom");
		
		ServiceHooks.driver.findElement(By.xpath("//md-dialog[contains(@aria-label,'Edit Building')]/form/div/*/button[1]")).click();
	}
